...
public class RoomList {
    ...
    public ArrayList<Room> createRooms() {
        ...
        rooms.add(new Room("Masters quaters "));//14
        rooms.add(new Room("Balcony"));//15
        rooms.add(new Room("Walkway"));//16
        rooms.add(new Room("Arcvies"));//17
...
// connect rooms both ways
        ...
        rooms.get(0).toString("Prison Cell\n" + "Cold and humid air makes you shiver. Rats running across the floor and spiders in the ceiling.\n"
        ...
        rooms.get(3).toString("Guards Room\n" + "You enter and see empty wine bottles laying around and a large table in the middle of the room, filled with playing cards.\n"
        ...
        rooms.get(4).toString("Hallway\n" + "You enter a long and dark hallway. there are cobwebs all over the ceiling and the air is stale and musty.\n"
                + "To the east, you see a door, but not where it leads.\n"
        ...
        rooms.get(9).toString("Weapon Storage\n" + "You enter a room filled with old rusty weapons. Nothing seems to have been maintained for a long time.\n"
        ...
        rooms.get(10).toString("Blacksmith’s Workshop\n" + "As you enter, you begin to cough. The air is filled with dust and ash. There are tools scattered all over the floor.\n"
        ...
        rooms.get(12).toString("Dining room\n" + "A room with a tall ceiling and a long table. there is what seems to be a throne at the end of the table. This must be the lord’s dining room.\n"
                + "To the north, you can see a door, but not where it leads.\n"
        ...
        rooms.get(13).toString("Art gallery\n" + "you enter a long passage filled with portraits and busts. you see many of the portraits are of the same person. That must be the lord himself.\n"
                + "To the north, you see a door, but not where it leads.\n"
                + "To the south, you see a door, but not where it leads.");
        ...
        rooms.get(14).toString("Masters quarters\n" + "you enter what seems to be the master quarters. there is a bed, and a desk filled with books and writing equipment.\n"
                + "To the north, you see glass doors, leading to a balcony.\n"
                + "To the east, you see a door, but not where it leads.\n"
                + "To the south, you see a door, but not where it leads.");
 
        rooms.get(15).setSouth(rooms.get(14));
        rooms.get(15).toString("Balcony\n" + "You step out onto the balcony. It is an amazing view over the lake. You feel calm again.\n"
        ...
        rooms.get(17).toString("Archives\n" + "As you enter the archives, you rows and rows of bookcases. There is a thick smell of old books.\n"
        ...
        rooms.get(18).toString("Harbour\n" + "As you step out of the gate, you are meet with a breeze of fresh air. It feels as if there was a great burden taken off you shoulders.\n"
                +  "To the north, you see the gate you came from.");
 
        rooms.get(19).setEast(rooms.get(12));
        rooms.get(19).setNorth(rooms.get(20));
        rooms.get(19).toString("Bridge\n" + "as you step through the door, you are met with a cold gust of wind. You have just stepped out on a bridge leading to a separate tower and the castle.\n"
                + "To the east, you see the door to the tower.\n"
                + "To the west, you see the door to the castle.");
 
        rooms.get(20).setSouth(rooms.get(19));
        rooms.get(20).setNorth(rooms.get(21));
        rooms.get(20).toString("Stairs\n" + "You enter the stairs of the tower. You get a ominous feeling from above. something is going on up there, and you not sure that you like it.\n"
